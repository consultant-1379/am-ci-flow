...
// Load Jobs configs
String jobDir = 'jenkins/eric-eo-lm-consumer'
def jobsList = listJobConfig(jobDir + '/jobs.yaml', this)
String gerritProject = 'OSS/com.ericsson.orchestration.mgmt/eric-eo-lm-consumer'
...
def jobPreReleaseFlow = new SCMPipelineJob(jobs['preRelease'])
